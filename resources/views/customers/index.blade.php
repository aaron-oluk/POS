    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="font-family:'Space Grotesk';font-weight:600;">{{ $c->orders_count }}</td>
          <td style="font-family:'Space Grotesk';font-weight:600;">${{ number_format($c->total_spent, 2) }}</td>
